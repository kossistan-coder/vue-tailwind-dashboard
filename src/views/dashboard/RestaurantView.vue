      ...
      <SideBarComponent></SideBarComponent>
       ...
       <div>
          <div class="flex justify-between items-center mb-5">
              <div>
                  <span class="text-white font-bold text-2xl">Home / Restaurants</span>
              </div>
              <div>
                <div>
                <div class="">
                    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Ajouter un restaurant</button>
                </div>
            </div>
              </div>
          </div>
