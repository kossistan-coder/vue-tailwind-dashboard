<template lang="">
    <div>
     <div>
      <SideBarComponent></SideBarComponent>
       <main class="flex min-h-screen flex-1 flex-col bg-gray-700  p-8 md:ml-60 max-md:pt-48">
       <div>
          <div class="flex justify-between items-center mb-5">
              <div>
                  <span class="text-white font-bold text-2xl">Home / Utilisateurs</span>
              </div>
              <div>
                <div>
                <div class="">
                    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Ajouter un utilisateur</button>
                </div>
            </div>
              </div>
          </div>
  ...
  <div class="relative overflow-x-auto shadow-md sm:rounded-lg max-md:mt-5">
      <div class="flex items-center justify-between flex-column md:flex-row flex-wrap space-y-4 md:space-y-0 p-4  bg-white dark:bg-gray-900">
          ...
          <div class="relative">
              ...
              <div class="relative">
                  <span class="absolute inset-y-0 inset-x-0 flex items-center px-3 pointer-events-none">
                      <font-awesome-icon icon="search" class="h-4 w-4 stroke-current text-gray-400" />
                  </span>
                  <input type="text" name="" value="" placeholder="search" class=" w-[20rem] max-md:w-[10rem] border-none rounded-xl px-10 py-4 focus:text-white focus:outline-none bg-gray-700" >
          ...
          <tbody>
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900">
                  ...
                  <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                      <img class="w-10 h-10 rounded-full" src="/img/avatar-1.jpeg" alt="Jese image">
                      <div class="ps-3">
              ...
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900">
                  ...
                  <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                      <img class="w-10 h-10 rounded-full" src="/img/avatar-2.jpeg" alt="Jese image">
                      <div class="ps-3">
              ...
              <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900">
                  ...
                  <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                      <img class="w-10 h-10 rounded-full" src="/img/avatar-3.jpeg" alt="Jese image">
                      <div class="ps-3">
      ...
      <nav class="flex items-center flex-column flex-wrap md:flex-row justify-between pt-4  pb-4" aria-label="Table navigation">
          <span class="text-sm font-normal text-gray-500 dark:text-gray-400 mb-4 md:mb-0 block w-full md:inline md:w-auto">Showing <span class="font-semibold text-gray-900 dark:text-white">1-10</span> of <span class="font-semibold text-gray-900 dark:text-white">1000</span></span>
          <ul class="inline-flex -space-x-px rtl:space-x-reverse text-lg h-8">
              <li>
                  ...
                  <div class="p-6 space-y-6">
                      <div class="grid grid-cols-6 gap-6">
                          <div class="col-span-6 sm:col-span-3">
                              <label for="first-name" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">First Name</label>
                          ...
                          <div class="col-span-6 sm:col-span-3">
                              <label for="last-name" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Last Name</label>
                          ...
                          <div class="col-span-6 sm:col-span-3">
                              <label for="phone-number" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Phone Number</label>
                          ...
                          <div class="col-span-6 sm:col-span-3">
                              <label for="department" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Department</label>
                          ...
                          <div class="col-span-6 sm:col-span-3">
                              <label for="company" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Company</label>
                          ...
                          <div class="col-span-6 sm:col-span-3">
                              <label for="current-password" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Current Password</label>
                          ...
                          <div class="col-span-6 sm:col-span-3">
                              <label for="new-password" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">New Password</label>
